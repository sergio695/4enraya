...
def obtenerStrTablero(tablero):
    ...
    return '''
      ...
      {}|{}|{}|{}  9 10 11 12
      -+-+-+-
      {}|{}|{}|{}  13 14 15 16'''.format(tablero['1'], tablero['2'], tablero['3'],
                                tablero['4'], tablero['5'], tablero['6'],
                                tablero['7'], tablero['8'], tablero['9'],
                                tablero['10'],tablero['11'], tablero['12'], tablero['13'],
                                tablero['14'], tablero['15'], tablero['16'])
